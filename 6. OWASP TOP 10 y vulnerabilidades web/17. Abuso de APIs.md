...
-   **Falsificación de solicitudes entre sitios [[7. Cross-Site Request Forgery (CSRF)]]**: los atacantes pueden enviar solicitudes maliciosas a una API en nombre de un usuario autenticado para realizar acciones no autorizadas.
